<html>
  <head>
    ...
    #A1 
    {
      ...
      padding: 200px;
      background: url("https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80");
...
<form method="post" action="connect_lib.php" >
...
<font size="4">
  ...
  <input type="text" id="book1" name="book1"  required><br><br>

  <label for="book2">2nd book name:</label>
  <input type="text" id="book2" name="book2"  required><br><br>

  <label for="book3">3rd book name:</label>
  <input type="text" id="book3" name="book3"  required><br><br>
